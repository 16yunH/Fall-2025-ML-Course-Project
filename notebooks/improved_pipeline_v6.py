"""
Improved Pipeline V6 - Final Push for Top Rank
Performance History:
- V1: CV 4.1271 → Submit 4.17495 (Gap: 0.048)
- V4: CV 4.1203 → Submit 4.16850 (Gap: 0.048)
- V5: CV 4.1193 → Submit 4.16787 (Gap: 0.048) - Micro improvement

Strategy:
- Polynomial features for key numerical features
- Feature importance-based selection
- Weighted ensemble with validation tuning
...
print("="*80)
print("Pipeline V6 - Final Aggressive Push")
print("="*80)
...
key_features = []
for feat in ['Age_Months', 'Weight_kg', 'Parity', 'Feed_Quantity_kg', 'Feed_Energy_MJ']:
...
submission_filename = f'submission_v6_{best_model_name.lower()}_{timestamp}.csv'
